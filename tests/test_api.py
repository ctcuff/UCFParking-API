...
# Workaround to be able to import app from api/app.py
sys.path.append('../')
...
class TestApi(unittest.TestCase):
    ...
    def validate_garage_data(self, garages):
        ...
        for garage in garages:
            ...
            self.assertEqual(garage['spaces_filled'] + garage['spaces_left'], garage['max_spaces'])
            self.assertTrue(garage['percent_full'] >= 0.0 and garage['percent_full'] <= 100.0)
